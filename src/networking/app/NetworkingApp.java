...
public class NetworkingApp {
    ...
    public static void main(String[] args) {
      ...
      // Node.AllNodes.get(0).Boadcast(new Message(Node.AllNodes.get(0),Node.AllNodes.get(Node.AllNodes.size()-1),System.currentTimeMillis(),"Message"));
        ...
        sendToNode(Node.AllNodes.get(1), Node.AllNodes.get(8), new Message(Node.AllNodes.get(1), Node.AllNodes.get(8), System.currentTimeMillis(),"test"));
        System.out.println("The minimum path from Node 1 to 8");
        Dijkstra.printShortestPath(Node.AllNodes.get(8));
        Node.reset();
        
        System.out.println("=======Quesiton J===========");
        double avgPower =findAvgPower(5);
        System.out.print("Average of N = 5 : ");
        System.out.println(avgPower);
        avgPower =findAvgPower(10);
        System.out.print("Average of N = 10 : ");
        System.out.println(avgPower);
        avgPower =findAvgPower(15);
        System.out.print("Average of N = 15 : ");
        System.out.println(avgPower);
        avgPower =findAvgPower(20);
        System.out.print("Average of N = 20 : ");
        System.out.println(avgPower);
    }
    
    public static void sendToNode(Node source, Node target, Message m) {
    ...
    public static double findAvgPower(int n) {
        Node.MakeGraph(n);
        ...
        for(int i = 0; i < 1000; i++) {
           ...
           // System.out.println("For Loop "+ i);
            ...
            sendToNode(firstNode, secondNode, m);
            totalPower += m.power;
            Node.reset();
        }
